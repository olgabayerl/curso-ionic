...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["denuncia-denuncia-module"], {
  ...
  function srcAppDenunciaDenunciaPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var denunciaPage = /*#__PURE__*/function () {
      function denunciaPage(alertController, formBuilder, denunciaService, storageService, geolocation, nativeGeocoder) {
      ...
      _createClass(denunciaPage, [{
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    _context4.next = 5;
                    return this.converteCoordenadas();
        ...
        key: "converteCoordenadas",
        value: function converteCoordenadas() {
                ...
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    this.nativeGeocoder.reverseGeocode(this.latitude, this.longitude, options).then(function (result) {
                      _this3.endereco = JSON.stringify(result[0]);
                      console.log(_this3.endereco);
                    })["catch"](function (error) {
